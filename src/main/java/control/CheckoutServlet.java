...
public class CheckoutServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (emailConsegna == null || emailConsegna.trim().equals("") || metodoPagamento == null
				|| metodoPagamento.trim().equals("") || nomeCarta == null || nomeCarta.trim().equals("")
				|| numeroCarta == null || numeroCarta.trim().equals("") || scadenzaCarta == null
				|| scadenzaCarta.trim().equals("") || cvv == null || cvv.trim().equals("")) {
